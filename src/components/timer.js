...
export default class Timer extends React.Component {
    ...
    render() {
        return (
            <div>Time Left to Complete: <Box component="span" className={styles.time} sx={{
                color: this.color
            }}>
                    {this.state.daysLeft}D {this.state.hoursLeft}hr {this.state.minutesLeft}min {this.state.secondsLeft}sec
                </Box> 
            </div>
        );
    }
